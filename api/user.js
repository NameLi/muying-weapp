...
export const getUserTokenByCode = (params) => http.post(`/oauth`, params);    // 登录获取token
...
export const uploadImage = (filePath, name, formData) => http.upload(`/upload`, filePath, name, formData);    // 文件上传
